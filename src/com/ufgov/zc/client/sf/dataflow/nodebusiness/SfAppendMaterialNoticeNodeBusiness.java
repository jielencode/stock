...
public class SfAppendMaterialNoticeNodeBusiness   implements ISfFlowNodeBusiness {
  ...
  private List<SfAppendMaterialNotice> getDataLst(BigDecimal entrustId,RequestMeta meta) {
    ...
    List<SfAppendMaterialNotice> evalst = zcEbBaseServiceDelegate.queryDataForList("com.ufgov.zc.server.sf.dao.SfAppendMaterialNoticeMapper.selectMainDataLst", dto, meta);    
    return evalst;
  }
