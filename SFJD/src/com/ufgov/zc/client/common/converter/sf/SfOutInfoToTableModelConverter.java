...
public static TableModel convertValidateTableData(List itemList) {
  ...
  static {
    detailInfo.add(new ColumnBeanPropertyPair(SfOutInfoType.COL_OUT_INFO_TYPE_NAME, "infoType.outInfoTypeName", LangTransMeta.translate(SfOutInfoType.COL_OUT_INFO_TYPE_NAME)));
    detailInfo.add(new ColumnBeanPropertyPair(SfOutInfoDetail.COL_TI_QU_FANG_SHI, "tiQuFangShi", LangTransMeta.translate(SfOutInfoDetail.COL_TI_QU_FANG_SHI)));
    ...
    detailInfo.add(new ColumnBeanPropertyPair(SfOutInfoDetail.COL_DESCRIPTION, "description", LangTransMeta.translate(SfOutInfoDetail.COL_DESCRIPTION)));
  }
  ...
  static {
    validateDetailInfo.add(new ColumnBeanPropertyPair(SfOutInfoReq.COL_OUT_INFO_REQ_NAME, "infoReq.outInfoReqName", LangTransMeta.translate(SfOutInfoReq.COL_OUT_INFO_REQ_NAME)));
    validateDetailInfo.add(new ColumnBeanPropertyPair(SfOutInfoValidateDetail.COL_VALIDATE_RESULT, "validateResult", LangTransMeta.translate(SfOutInfoValidateDetail.COL_VALIDATE_RESULT)));
    validateDetailInfo.add(new ColumnBeanPropertyPair(SfOutInfoValidateDetail.COL_REMARK, "remark", LangTransMeta.translate(SfOutInfoValidateDetail.COL_REMARK)));
  }
