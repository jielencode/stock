...
public class ZcAgencyDao extends SqlMapClientDaoSupport implements IZcAgencyDao {
  ...
  public List selectAgency(ElementConditionDto dto, RequestMeta meta) {
    dto.setNumLimitStr(NumLimUtil.getInstance().getNumLimCondByCoType(dto.getWfcompoId(), NumLimConstants.FWATCH));
    List list = getSqlMapClientTemplate().queryForList("ZC_B_AGENCY.getZcBAgencyList", dto);
    return list;
  }

  public void doSave(ZcBAgency zcBAgency) {
    getSqlMapClientTemplate().insert("ZC_B_AGENCY.insertZcBAgency", zcBAgency);
  }

  public List getIsExists(ZcBAgency zcBAgency) {
    return getSqlMapClientTemplate().queryForList("ZC_B_AGENCY.getZcBExistsAgencyList", zcBAgency);
  }

  public List getPriKey(ZcBAgency zcBAgency) {
    return getSqlMapClientTemplate().queryForList("ZC_B_AGENCY.getPriKey", zcBAgency);
  }
  ...
  public void doDelete(ZcBAgency zcBAgency) {
    getSqlMapClientTemplate().delete("ZC_B_AGENCY.deleteZcBAgency", zcBAgency);
  }
